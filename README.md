...
![](assets/markdown-img-paste-20190107193821192.png)

This will upload a set of Entity Types and Relation Types.
![](assets/markdown-img-paste-20190107193856113.png)

![](assets/markdown-img-paste-20190107193921616.png)
...
![](assets/markdown-img-paste-20190107194021625.png)

![](assets/markdown-img-paste-20190107194040755.png)
...
![](assets/markdown-img-paste-20190107194220973.png)
...
![](assets/markdown-img-paste-20190107194306914.png)

Once completed, you will see the results of the train and evaluate process.
![](assets/markdown-img-paste-20190107195958447.png)

You can view the log files of the process by clicking the `View Log` button from the `Performance` page.
![](assets/markdown-img-paste-20190107200135440.png)

## 7. Deploy the machine learning model to Watson Discovery

Now we can deploy our new model to the already created **Watson Discovery** service. Navigate to the `Version` menu on the left and press `Create Version`. Provide a description for the snapshot you are about to create.

![](assets/markdown-img-paste-2019010720024912.png)
...
Then enter your IBM Cloud account information to locate your **Discovery** service to deploy to. Navigate to the exact Space or Resource Group where you have created your **Discovery** service. By default it should be in the `default` resource group.

![](assets/markdown-img-paste-20190107200549588.png)
...
![](assets/markdown-img-paste-20190107200726606.png)
...
Launch the **Watson Discovery** tool, from the IBM Cloud Dashboard page. Click **Launch tool**
![](assets/markdown-img-paste-20190107200901490.png)

Create a **new data collection** uploading your own data
and give the data collection a unique name.
> Note: the tool might configure storage for you, accept the default when asked.

![](assets/markdown-img-paste-20190107201134102.png)
...
![](assets/markdown-img-paste-20190107201308973.png)
## 9. Configure credentials

Open a terminal where you have cloned the repository.
...
## 11. (Optional) Deploy and run the application on IBM Cloud
